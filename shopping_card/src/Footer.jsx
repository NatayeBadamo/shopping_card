      ...
      <footer className="bg-slate-50">
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
                  <div className="lg:flex lg:items-center lg:justify-between">
                        ...
                        <p className='text-lg font font-bold'>MottoMaster</p>
                        </div>
                              ...
                              <div className="mx-auto mt-8 max-w-md sm:ms-0">
                                    ...
                                    <form className="mt-4">
                                          <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                                                ...
                                                <input
                                                className="w-full rounded-full border-gray-200 px-6 py-3 shadow-sm focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
                                                type="email"
                                                placeholder="Enter your email"
                                                />

                                                <button
                                                className="block rounded-full bg-sky-500 px-8 py-3 font-medium text-white transition hover:bg-sky-600"
                                                type="submit"
                                                >
                                                Subscribe
                                                </button>
                  ...
                  <div className="mt-16 border-t border-gray-100 pt-6 sm:flex sm:items-center sm:justify-between">
                        ...
                        Copyright &copy; Na'taye Badamo 2024. All rights reserved.
                        </p>
                        ...
                        <a
                              ...
                              rel="noreferrer"
                              target="_blank"
                              className="text-sky-700 transition hover:text-teal-700/75"
                        >
